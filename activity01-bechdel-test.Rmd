...
**Response**: The movies that fail have a higher budget and gross more money than those that fail
...
**Response**: The movies that pass the test still have the lowest median budget and lowest median domestic and international gross. However, the women don't talk to each other has the highest median values in all three categories not the nowomen. Although the nowomen has the 2nd highest median budget.
...
**Response**: It looks like all the categories have a similar boxplots, however the categories that fail the test seem to have many more outliers with high rois
